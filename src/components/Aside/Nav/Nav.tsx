...
const Nav = () => {
    return (
        <nav className={s.nav}>
            <ul className="top">
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/"> <img src={homeIcon} alt="Sale"/></NavLink></li>
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/sale"> <img src={saleIcon} alt="Sale"/></NavLink></li>
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/sale"> <img src={searchIcon} alt="Search"/></NavLink></li>
            </ul>
            <ul className={s.bottom}>
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/sale"> <img src={settingsIcon} alt="Settings"/></NavLink></li>
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/sale"> <img src={chatIcon} alt="Chat"/></NavLink></li>
                <li><NavLink className={(navData) => (navData.isActive ? s.activeL : 'none')}
                             to="/sale"> <img src={exitIcon} alt="Exit"/></NavLink></li>
            </ul>
        </nav>
    );
};
